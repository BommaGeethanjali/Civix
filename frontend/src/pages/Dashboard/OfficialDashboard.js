...
import { FaHome, FaFileAlt, FaPoll, FaChartBar, FaCog, FaQuestionCircle, FaBell, FaMapMarkerAlt, FaCheckCircle, FaCalendarAlt, FaBullhorn, FaUserEdit, FaFileContract, FaUsers } from 'react-icons/fa';
        ...
        <div className="official-dashboard-container">
            ...
            <nav className="official-top-navbar">
                ...
                <div className="official-navbar-right">
                    <button className="official-navbar-bell">
                        <FaBell />
                        <span className="notification-badge">3</span>
                    </button>
                    <div className="official-navbar-profile">
                        <div className="official-navbar-avatar">
