...
import { FaHome, FaFileAlt, FaPoll, FaChartBar, FaCog, FaQuestionCircle, FaBell, FaMapMarkerAlt, FaUser, FaCheck, FaExclamationTriangle, FaComment, FaTimes, FaClock, FaTrash, FaUserTie } from 'react-icons/fa';
    ...
    <div className="dashboard-container">
      ...
      <header className="top-bar-global">
        ...
        <div className="top-bar-actions">
          ...
          <button className="profile-btn-top">{user?.fullName?.charAt(0).toUpperCase()}</button>
