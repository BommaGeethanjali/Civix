...
import { FaHome, FaFileAlt, FaPoll, FaChartBar, FaCog, FaQuestionCircle, FaBell, FaMapMarkerAlt } from 'react-icons/fa';
import './Layout.css';
...
const Layout = ({ children }) => {
  ...
  const getDashboardRoute = () => {
    if ((user?.userType || '').toLowerCase() === 'official') return '/official-dashboard';
